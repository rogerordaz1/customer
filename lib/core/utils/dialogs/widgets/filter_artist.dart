...
class FilterArtist extends StatelessWidget {
  const FilterArtist({super.key});
            ...
            children: [
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    const AppTextField(
                        isSearchTextfield: true, hintText: 'Buscar artistas'),
                    ...
                    ...List.generate(
                      ...
                      (i) => Container(
                        ...
                        child: RadioListTile<String>(
                            ...
                            value: 'Navarro $i',
                            title: Text('Navarro', style: AppTextStyles.base),
                            groupValue: null,
                            onChanged: (value) {}),
                      ),
                    ),
